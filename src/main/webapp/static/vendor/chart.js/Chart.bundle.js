...
Color.prototype.setValues = function (space, vals) {
	...
	// converter to all the other color spaces
...
module.exports = function() {
	...
	// Private helper function to converter max-width/max-height values that may be percentages into a number
...
defaults._set('scale', {
	...
	ticks: {
		...
		autoSkipPadding: 0,
		labelOffset: 0,
		// We pass through arrays to be rendered as multiline labels, we converter Others to strings here.
...
module.exports = function(Chart) {
	...
	var defaultConfig = {
		...
		pointLabels: {
			...
			// Function - Used to converter point labels
...
function momentify(value, options) {
	...
	// The user might still use the deprecated `format` option to converter his inputs.
